...
** Sept 18, 2019
 ...
 + [ ] Trig simplification step
   - The usual trig functions will refuse to evaluate if in symbolic
     mode
   - [ ] Write a simplification that solves any "known" trig function
     values exactly
   - [ ] Inverse trig functions as well
   - [ ] Solver for transcendentals as well
   - [ ] Powers?
   - [ ] Powers need to not evaluate if they'll produce a floating
